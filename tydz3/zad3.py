...
# def czy_mozna_jeść_kebaba_i_piwo(zapotrzebowanie_kaloryczne, zjedzone_kalorie, spalone_kalorie, planowane_kalorie):
#     dostepne_kalorie = zapotrzebowanie_kaloryczne - zjedzone_kalorie + spalone_kalorie
#     kalorie_kebabu = 600
#     kalorie_piwa = 150

#     if dostepne_kalorie >= (kalorie_kebabu + kalorie_piwa + planowane_kalorie):
#         return "Możesz sobie pozwolić na zjedzenie kebaba i wypicie piwa dziś!"
#     else:
#         return "Niestety, przekroczyłbyś limit kalorii na dzisiaj po zjedzeniu kebaba i wypiciu piwa."

# zapotrzebowanie_kaloryczne = int(input("Podaj zapotrzebowanie kaloryczne: "))
# zjedzone_kalorie = int(input("Podaj zjedzone kalorie: "))
# spalone_kalorie = int(input("Podaj spalone kalorie: "))
# planowane_kalorie = int(input("Podaj planowane kalorie: "))

# wynik = czy_mozna_jeść_kebaba_i_piwo(zapotrzebowanie_kaloryczne, zjedzone_kalorie, spalone_kalorie, planowane_kalorie)
# print(wynik)
